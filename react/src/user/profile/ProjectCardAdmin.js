    ...
    if(!props.approuved){
        return(
            <Card style = {{margin : 20 }}>
                ...
                <CardActions>
                    <Button type="button" variant="contained" color="primary" onClick={()=>{props.fctApprouve(props.id)}} >
                        Approuver 
                    </Button>
                </CardActions>
        </Card>
        ...
        return(
            <Card style = {{margin : 20 }}>
                ...
                <CardActions>
                    <Button type="button" variant="contained" color="danger" onClick = {()=>{props.fctDesapprouve(props.id)}}>
                        Annuler
                    </Button>
                </CardActions>
        </Card>
